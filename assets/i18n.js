...
const DICT = {
  ja: {
    ...
    geocoding: "住所を検索中…",
    geocodeError: "住所から座標を取得できませんでした。番地まで詳しく入力するか、「現在地の座標を使う」をお試しください。",
  ...
  en: {
    ...
    geocodeError: "Couldn't find coordinates for that address. Try a more complete address, or use your current location instead.",
