...
const DICT = {
  ja: {
    ...
    geocoding: "取得中…",
    geocodeError: "住所から座標を取得できませんでした。地図を直接タップして場所を指定してください。",
    coordsRequired: "地図をタップして店舗の場所を指定してください。",
    mapTapHint: "地図をタップ、またはピンをドラッグして、正確な場所を指定してください。",
    listingFee: "掲載料",
    payAndList: "支払って掲載する",
    ...
    myStoreDeleteConfirm: "本当にこの店舗の登録を取り消しますか？この操作は元に戻せません。",
  ...
  en: {
    ...
    geocoding: "Looking up…",
    geocodeError: "Couldn't find that address. Please tap the map to set the location directly.",
    coordsRequired: "Please tap the map to set your store's location.",
    mapTapHint: "Tap the map, or drag the pin, to set the exact location.",
    ...
    myStoreDelete: "Delete listing",
    myStoreDeleteConfirm: "Are you sure you want to delete this listing? This cannot be undone.",
