...
const DICT = {
  ja: {
    ...
    phone: "電話番号(任意)",
       website: "ウェブサイト(任意)",
    email: "メールアドレス(任意・掲載期限のお知らせ用)",
    currencies: "受け付ける決済",
        useMyLocation: "現在地の座標を使う",
    geocodeFromAddress: "住所から座標を取得",
    geocoding: "住所を検索中…",
          geocodeError: "住所から座標を取得できませんでした。番地まで詳しく入力するか、地図をタップして場所を指定してください。",
    coordsCaptured: "座標を取得しました",
    manualCoordsHint: "自動で取得できない場合は、Googleマップでお店の場所を右クリック(スマホは長押し)すると表示される緯度・経度を、上の欄に直接入力することもできます。",
    coordsRequired: "地図をタップするか、「住所から座標を取得」「現在地の座標を使う」で場所を指定してください。",
    geocodingOnSubmit: "住所から座標を検索中…",
    mapTapHint: "地図をタップ、またはピンをドラッグして、正確な場所を指定することもできます。", 
    listingFee: "掲載料",
    payAndList: "支払って掲載する",
    ...
    myStorePayError: "処理に失敗しました。時間をおいて再度お試しください。",
       myStoreEditInfo: "店舗情報を編集",
    myStoreEditSave: "保存する",
    myStoreEditCancel: "キャンセル",
    myStoreEditSuccess: "更新しました。",
    myStoreDelete: "登録を取り消す",
    myStoreDeleteConfirm: "本当にこの店舗の登録を取り消しますか？この操作は取り消せません。",
    ...
    // testnet-period free registration
       freeRegistrationBanner: "現在Testnet期間中のため、Pi決済不要で無料で店舗登録できます。Mainnet移行後は通常の掲載料(1π/6ヶ月)が必要になります。",
  ...
  en: {
    ...
    email: "Email (optional, for expiry reminders)",
    currencies: "Accepted payments",
       useMyLocation: "Use my current coordinates",
    geocodeFromAddress: "Get coordinates from address",
    geocoding: "Looking up address…",
           geocodeError: "Couldn't find coordinates for that address. Try a more complete address, or tap the map to set the location.",
    coordsCaptured: "Location captured",
    manualCoordsHint: "If automatic lookup doesn't work, you can look up the coordinates yourself in Google Maps (right-click, or long-press on mobile, on the location) and type them in above.",
    coordsRequired: "Tap the map, or use address lookup / current location, to set where this place is.",
    geocodingOnSubmit: "Looking up coordinates from the address…",
    mapTapHint: "You can also tap the map, or drag the pin, to set the exact location.",
    ...
    myStorePayError: "Something went wrong. Please try again later.",
        myStoreEditInfo: "Edit store info",
    myStoreEditSave: "Save",
    myStoreEditCancel: "Cancel",
    myStoreEditSuccess: "Updated.",
    myStoreDelete: "Cancel this listing",
    myStoreDeleteConfirm: "Are you sure you want to withdraw this listing? This cannot be undone.",
    myStoreDeleteSuccess: "Listing removed.",
    myStoreDeleteError: "Failed to remove listing. Please try again later.",
    // richer venue info
    hours: "Opening hours",
    ...
    // testnet-period free registration
       freeRegistrationBanner: "Free registration during the Testnet period — no Pi payment needed. The usual listing fee (1π every 6 months) applies once we move to Mainnet.",
