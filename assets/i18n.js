...
const DICT = {
  ja: {
    ...
    geocoding: "住所を検索中…",
       geocodeError: "住所から座標を取得できませんでした。番地まで詳しく入力するか、「現在地の座標を使う」をお試しください。下の欄に緯度・経度を直接入力することもできます。",
    coordsCaptured: "座標を取得しました",
    manualCoordsHint: "自動で取得できない場合は、Googleマップでお店の場所を右クリック(スマホは長押し)すると表示される緯度・経度を、上の欄に直接入力することもできます。",
    coordsRequired: "緯度・経度を入力してください(「住所から座標を取得」「現在地の座標を使う」、または直接入力)。",
  ...
  en: {
    ...
    geocoding: "Looking up address…",
       geocodeError: "Couldn't find coordinates for that address. Try a more complete address, or use your current location instead. You can also type the coordinates in directly below.",
    ...
    coordsRequired: "Please provide coordinates (via address lookup, current location, or by entering them directly).",
